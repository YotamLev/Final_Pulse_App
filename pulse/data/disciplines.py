...
DISCIPLINES: dict[str, dict] = {
    "Auspex": {
        ...
        "powers": [
            ...
            {"name": "Anticipation", "level": 2, "description": "Pay 1 Blood, add Auspex to rollד made to dodge or defend against all kinds of attacks and dangers, for a scene.", "requires": None},
    ...
    "Druidic": {
        ...
        "powers": [
            ...
            {"name": "Earth Meld", "level": 2, "description": "Pay 1 Blood, sink into and become one with soil. Leave when you wish. Cannot travel in this state.", "requires": None},
